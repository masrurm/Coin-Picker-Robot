...
void _ftoa (float a)
{
	...
	int sign;
	int bin_exp;
	int dec_exp; // Decimal exponent
	unsigned char bcd_man[5]={0, 0, 0, 0, 0}; // BCD mantisa has at least 9 digits
	int j, k;
	...
	_taos[0] =sign;
	_taos[1] =ASCII[bcd_man[4]%0x10];
	_taos[2] ='.';
	_taos[3] =ASCII[bcd_man[3]/0x10];
	_taos[4] =ASCII[bcd_man[3]%0x10];
	_taos[5] =ASCII[bcd_man[2]/0x10];
	_taos[6] =ASCII[bcd_man[2]%0x10];
	_taos[7] =ASCII[bcd_man[1]/0x10];
	_taos[8] =ASCII[bcd_man[1]%0x10];
	_taos[9] =ASCII[bcd_man[0]/0x10];
	_taos[10]='E';
	if(dec_exp<0)
	{
		dec_exp*=-1;
	...
	_taos[12]=ASCII[dec_exp/10];
	_taos[13]=ASCII[dec_exp%10];
	_taos[14]=0;
}
